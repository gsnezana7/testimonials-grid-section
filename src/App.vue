...
const testimonials = [
  ...
  },
  {
    ...
    quote: "Before joining the bootcamp, I’ve never written a line of code. I needed some structure fro professionals who can help me learn programming step by step. I was encouraged to enroll by a former student of theirs who can only say wonderful things about the program. The entire curriculum and staff did not disappoint. They were very hands-on and I never had to wait long for assistance. The agile team project, in particular, was outstanding. It took my learning to the next level in a way that no tutorial could ever have. In fact, I’ve often referred to it during interviews as an example of my development experience. It certainly helped me land a job as a full-stack developer after receiving multiple offers. 100% recommend!",
    gridArea: 'kira'
  },
];
...
<template>
  <section class="container">
    <h1 class="visually-hidden">Testimonials grid section</h1>
    <ul class="list-grid">
      <li v-for="card in testimonials" :key="card.id" :class="['list-grid__item', `list-grid__item--${card.gridArea}`]">
        <AppCard v-bind="card" :theme="card.gridArea" />
      </li>
    </ul>
  </section>
  <Footer />
...
.list-grid {
  ...
  padding: 0;
  list-style: none;
  gap: fluid(28, 30, 375, 1470);

  @media (rem(600) <=width < rem(1024)) {
